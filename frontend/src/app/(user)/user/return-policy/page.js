        ...
        <div className="space-y-8 text-[15px] text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              The arrangement between the Sellers and My Pharma is governed by
              this Privacy Policy and the Terms of Use. The Services are
              available to natural persons who have registered on the Website
              following the procedures determined by My Pharma from time to time
              (referred to as “You” or “Your” or “User”, which terms also
              include visitors).
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-3">
              To provide the Services and other purposes identified in this
              Privacy Policy, My Pharma collects and hosts certain data and
              information of the Users. We are committed to protecting the
              Personal Information of Users and take all reasonable precautions
              to maintain confidentiality. This Privacy Policy helps you
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              Services without creating an account. To access all features and
              benefits, a User may need to create an account. As part of the
              registration process, My Pharma may collect the following
              categories of Personal Information (“User Information”):
            </p>
            <ul className="list-disc ml-5 space-y-1">
              <li>Name</li>
              <li>User ID</li>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              for the purposes mentioned in this Privacy Policy and the Terms of
              Use, including:
            </p>
            <ul className="list-disc ml-5 space-y-1">
