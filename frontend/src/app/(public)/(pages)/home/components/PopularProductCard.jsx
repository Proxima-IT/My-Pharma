 ...
 * Updated: Added Markdown/HTML stripping logic to display a clean plain-text description snippet.
 */
const PopularProductCard = ({ product }) => {
   ...
   * Removes headers, bold, italics, links, and all HTML elements.
   */
