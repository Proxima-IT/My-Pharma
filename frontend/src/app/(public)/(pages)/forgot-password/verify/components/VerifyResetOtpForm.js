  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 mt-3 font-medium leading-relaxed text-center">
          We have sent a verification code to {identifierType === 'email' ? 'email address' : 'phone number'} <br />
