...
export default function CompleteRegistrationPage() {
  // Bulletproof styles to ensure centering and background rendering
  const pageStyle = {
    ...
    padding: '80px 24px', // Increased vertical padding for a more relaxed entry
  };

  return (
    <main style={pageStyle}>
      {/* Constrained container: max-w-150 = 600px */}
      <div className="w-full max-w-150 flex flex-col gap-12">
        ...
        {/* Form Card - Pure White, Borderless, Ultra-Smooth Corners */}
