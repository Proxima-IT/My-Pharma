  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <form onSubmit={handleVerify} className="w-full space-y-8">
        {/* 6-Digit Input Grid - Using Grid for strict containment */}
                ...
                className={`
                  ...
                  ${
                    isError
                      ...
                      : isActive
                        ? 'bg-green-500/10 border-green-500 ring-4 ring-green-500/20 text-gray-900'
        ...
        {error && (
          <p className="text-center text-sm font-bold text-red-500 animate-in fade-in slide-in-from-top-1">
            {error}
          </p>
        )}
