...
const BookTestBanner = () => {
  return (
    <div>
      ...
      /> */}
        <div
          className="w-full min-h-[480px] lg:min-h-0 bg-center bg-no-repeat bg-cover rounded-xl min-w-full grid grid-cols-1 lg:grid-cols-2 items-start justify-center gap-6 py-9 relative overflow-hidden lg:overflow-visible"
          style={{
        ...
        >
          <div className="flex justify-center lg:justify-end items-start lg:items-end position-relative pt-6 lg:pt-0 order-1 lg:order-2">
            <Image
              ...
              width={340}
              height={380}
              className="rounded-lg w-4/5 max-w-[340px] lg:w-[340px] lg:absolute lg:bottom-0 lg:top-0.5 lg:right-0 lg:lg:right-10 lg:-translate-y-1/4"
            />
          </div>
          {/* Content */}
